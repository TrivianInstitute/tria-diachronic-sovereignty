...
```text
Adapted from TRIA Diachronic Sovereignty by Sarasha Elion.
Changes were made. This adaptation is licensed under CC BY-NC-SA 4.0.
```

When relying on a specific paper, DOI record, software repository, dataset, schema, or implementation, cite that source separately under its applicable terms.
...
Submitting an issue, comment, pull request, suggestion, or other contribution does not transfer ownership of TRIA Diachronic Sovereignty or its pre-existing materials.
